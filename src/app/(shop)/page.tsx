    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Link href="/catalog" className="bg-green-500 hover:bg-green-600 text-white px-8 py-3.5 rounded-full font-semibold transition-colors flex items-center justify-center gap-2">
                Смотреть каталог <ArrowRight size={18} />
              </Link>
              <Link href="/order-terms" className="border border-green-200 hover:border-green-400 text-green-600 px-8 py-3.5 rounded-full font-semibold transition-colors text-center">
                Условия заказа
              </Link>
            </div>
          </div>
      ...
      <section className="py-14 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-end justify-between mb-8">
          <div>
            <p className="text-green-500 text-sm font-medium uppercase tracking-widest mb-1">Ассортимент</p>
            <h2 className="text-3xl font-bold text-gray-900">Категории</h2>
          </div>
          <Link href="/catalog" className="text-green-500 hover:text-green-700 text-sm font-medium flex items-center gap-1">
      ...
      <section className="py-14 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-end justify-between mb-8">
            <div>
              <p className="text-green-500 text-sm font-medium uppercase tracking-widest mb-1">Популярное</p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="bg-gradient-to-r from-green-500 to-lime-500 rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <Link href="/checkout" className="bg-white text-green-600 hover:bg-green-50 px-8 py-3.5 rounded-full font-bold transition-colors inline-flex items-center gap-2">
