  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="text-center mb-12">
        <p className="text-green-500 font-medium text-sm uppercase tracking-widest mb-3">Информация</p>
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={step} className="flex items-start gap-4">
                <span className="bg-green-500 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shrink-0">{step}</span>
            ...
            {[
              ...
              <div key={title} className="border border-gray-100 rounded-2xl p-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-green-500 font-semibold text-sm">{price}</span>
                </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {['Наличными курьеру', 'Картой онлайн', 'Картой курьеру', 'СБП (QR-код)'].map(method => (
              <div key={method} className="bg-green-50 rounded-xl p-3 text-center text-sm text-green-700 font-medium">
                {method}
              </div>
            ))}
          </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-lime-500 rounded-3xl p-8 text-white">
          ...
          <p className="text-green-100 mb-6">Наши менеджеры всегда готовы помочь с выбором и оформлением заказа.</p>
          <div className="flex flex-wrap gap-3">
            <a href="tel:+79991234567" className="bg-white text-green-600 hover:bg-green-50 px-6 py-2.5 rounded-full font-semibold transition-colors text-sm">
              +7 (999) 123-45-67
            </a>
